...
local function producer(message)
    ...
    print("kafka server: ", kafkaServer)
    local messageString = table_to_string(message)
    print("traffic res: ", messageString)
    if kafkaServer~=nil then
        ...
        producer:produce(topic, KAFKA_PARTITION_UA, messageString)
